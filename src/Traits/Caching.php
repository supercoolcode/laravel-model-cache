...
namespace Cool\LaravelModelCache\Traits;

use Closure;
use Cool\LaravelModelCache\CachedBuilder;
use Cool\LaravelModelCache\CacheKey;
use Cool\LaravelModelCache\CacheTags;
